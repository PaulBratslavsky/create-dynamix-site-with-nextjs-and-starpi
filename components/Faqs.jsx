...
const data = {
  ...
  description: "We try to answer most of your Questions.",
  linkId: "faqs",
  faqs: [
    {
      id: 1,
      question: "Which are the network hospitals in your vicinity?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra ultrices nunc, non at",
    },
    {
      id: 2,
      question: "What is the procedure to avail the cashless facility?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra ultrices nunc, non at",
    },
    {
...
export default function Faqs() {
  const { heading, description, linkId, faqs } = data;
  return (
    <div id={linkId} className="mx-auto container px-4 xl:px-0 my-24">
